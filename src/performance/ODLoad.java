...
public class ODLoad {
	 private WebDriver driver ;
	  ...
	  //public void testStudentScheduling(){
	    ...
	    Thread.sleep(500);
	    new Select(driver.findElement(By.id(StudentPath.CourseID))).selectByVisibleText("Algebra");
	    driver.findElement(By.xpath(StudentPath.QuestionXpath)).sendKeys("Testing don't pick "+Username);
